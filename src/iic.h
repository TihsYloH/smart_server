...
int  set_time(unsigned int year0,unsigned int year1,unsigned int month,unsigned int day,
...
/*
 eeprom table
 addr
 20  zigdev version en
 21-24 zigdev version
 */

#define   ZIGDEV_VERSION    20
